...
export const STEPS: GuideStep[] = [
  // Chapter 1 — the things that matter
  {
    ...
    why: 'Any treasure can go in the binder with just a photo — the story is the one part no one else can recover, and one is enough to begin.',
  ...
  },
  {
    id: 'story-five',
    chapter: 'things',
    title: 'Tell five stories',
    why: 'Five is enough for your family to feel the house speak — one per visit is a fine pace.',
    minutes: 'ten minutes each',
    route: '/add',
    togetherScript: 'One story per visit is plenty. Pick any treasure already in the binder — or a new one — ask “what’s the story behind this one?” and hold the phone while she talks.',
  ...
  },
  {
    ...
    why: 'One person who could ask for binder access if it were ever needed — that door opens slowly by design, which is why papers like a power of attorney do their work as copies already in loved ones’ hands.',
    minutes: 'about five minutes',
    route: '/family',
    heavy: true,
    togetherScript:
